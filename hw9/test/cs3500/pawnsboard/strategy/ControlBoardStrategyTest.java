...
public class ControlBoardStrategyTest {
    ...
    private static class MockModel implements IPawnsBoardModel {
        ...
        public boolean canPlaceCard(int handIndex, int row, int col, PlayerColor color) {
            return false;
        }
    }
    ...
    public void testSingleBestMove() {
        ...
        // Because the strategy tries each cell, the difference is in the "control" count after simulation.
        ...
        // For demonstration, let's assume we just see that it picks row=0 col=0 for row-major tie-break.
