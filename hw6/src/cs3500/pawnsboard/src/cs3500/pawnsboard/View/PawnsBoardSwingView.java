 ...
 *  - A status area at the top, showing current player & maybe scores
 */
public class PawnsBoardSwingView extends JFrame implements IPawnsBoardGuiView {
    ...
    private final JLabel statusLabel; // for "Current player: X"
    ...
    public PawnsBoardSwingView(ReadOnlyPawnsBoardModel model) {
        ...
        // We give boardPanel a reference to this view (or to the controller) if we want:
        ...
        this.addKeyListener(new KeyAdapter() {
            ...
            public void keyPressed(KeyEvent e) {
                ...
                if (code == KeyEvent.VK_ENTER) {
                    controller.onConfirm(); // print debug in stub
                }
                else if (code == KeyEvent.VK_P) {
                    controller.onPass(); // print debug in stub
                }
            }
        });
